-- ----------------------- single line comment -----------
  ...
  */
  ...
  T11: Promotions (PromotionID, SoldierID, PreviousRank, NewRank, PromotionDate, ApprovedBy, Remarks, Reason, UnitID, DocumentRef )
  T12: Leaves(  leaveId , SoldierId , LeaveType , StartDate , EndDate ,  ApproveBy, Reason , Status , ApplicationDate , remark )
  T13: Evaluations( EvaluationId ,SoldierId , EvalutorId , EvaluationDate , phisycalScore ,TacticalScore , Comments , finalGrade, UnitId , TrainingId )
  T14: DisciplinaryActions ( ActionId , SoldierId , incidentDate , Desciption , ActionTaken , ApproveBy , Seveirty ,UnitId,Remarks , DurationsDays )
  T15: Devlpoyments ( DevlepmentId , SoldierId , StartDate , EndDate , Location , MissinId  , Role  ,UnitId , Status , CommanderId )
  T16: CommunicationLogs( CommId ,SenderId , ReceiverId , Massage , DateSent ,Timesent , Method , Urgency , MissionId ,Status )
  T17: inventory ( inventoryId , itemName , Quentety , ItemType ,UnitId , Location  , IssuedTo , IssuedDate ExpiryDate , Remarks ) 
  T18: Ammunitions (AlmmoId ,Type , Caliber , Quentety , manufactureDate , ExpiryDate , UnitId ,StorgeLocation ,condition , lastinspection )
  T19: Equipment (EquipmentId , Name , type , Quentety , AssignedUnit , Condition , Lastmaintenance , Manufacturer , SerialNumber ,AcquisitionDate)
  T20: MaintenanceLogs ( LogID, EquipmentID, DateOfMaintenance, TechnicianID, Description, Status, NextDue, Remarks, Cost, UnitID )
...
drop table MissionReports;
 ...
 -- table 11 Promotions 
 -- create table Promotions (PromotionID, SoldierID, PreviousRank, NewRank, PromotionDate, ApprovedBy, Remarks, Reason, UnitID, DocumentRef )
 create table  Promotions 
 ( PromotionID int primary key ,
 SoldierID int , 
 PreviousRank varchar(30),
 NewRank varchar(50),
 PromotionDate date, 
 ApprovedBy int,
 Remarks text,
...
-- table 12 Leaves
-- create table Leaves(  leaveId , SoldierId , LeaveType , StartDate , EndDate ,  ApproveBy, Reason , Status , ApplicationDate , remark )
create table Leaves( 
...
-- create table Evaluations( EvaluationId ,SoldierId , EvalutorId , EvaluationDate , phisycalScore ,TacticalScore , Comments , finalGrade, UnitId , TrainingId )
